...
function PageLoader({ fullScreen = true }: PageLoaderProps) {
  return (
    ...
    >
      ...
      {fullScreen && (
        <div className="absolute top-1/2 left-1/2 -tranneutral-x-1/2 -tranneutral-y-1/2 w-64 h-64 rounded-full bg-primary/5 dark:bg-primary/5 blur-3xl pointer-events-none" />
      )}
      ...
      <div className="w-full max-w-lg space-y-6 animate-pulse relative z-10">
        ...
        <div className="flex flex-col items-center space-y-3">
          ...
          <div className="h-5 bg-gray-200 dark:bg-neutral-800 rounded-full w-1/3" />
        </div>

        {/* Separador decorativo */}
        <div className="h-[1px] bg-gray-200/60 dark:bg-neutral-800/60 w-1/2 mx-auto" />

        {/* Bloque de líneas de texto simulando párrafos */}
        <div className="space-y-3 max-w-md mx-auto">
          <div className="h-3.5 bg-gray-200 dark:bg-neutral-800 rounded-full w-full" />
          <div className="h-3.5 bg-gray-200 dark:bg-neutral-800 rounded-full w-11/12 mx-auto" />
          <div className="h-3.5 bg-gray-200 dark:bg-neutral-800 rounded-full w-4/5 mx-auto" />
        </div>

        {/* Mensaje sutil debajo del esqueleto */}
        <p className="text-[11px] font-medium tracking-wider text-gray-400 dark:text-neutral-500 uppercase pt-4">
