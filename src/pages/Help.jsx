    ...
    <>
      ...
      <Section>
        ...
        <p className="mt-2 text-gray-700 max-w-2xl">
          ...
          alguien, no estás solo. Existen distintas formas de recibir apoyo,
          y todas son válidas.
        </p>
      </Section>
      ...
      <Section title="¿Cuándo es buena idea buscar ayuda?">
        <div className="max-w-3xl space-y-4 text-gray-700">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>Te sientes triste, ansioso o vacío la mayor parte del tiempo</li>
      ...
      <Section>
        <div className="rounded-2xl border border-default bg-neutral-primary-soft p-8 text-center">
          ...
          <p className="text-sm text-gray-600">
            Si sientes que estás en riesgo inmediato, busca ayuda de emergencia
            en tu país.
          </p>
        </div>
      </Section>
