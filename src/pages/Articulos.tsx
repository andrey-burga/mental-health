    ...
    <PageTransition>
      <div className="min-h-screen flex flex-col bg-slate-50/30 dark:bg-slate-950 text-slate-800 dark:text-gray-100 transition-colors duration-300">
        ...
        <main className="flex-grow">
              ...
              <div className="max-w-7xl mx-auto">
                ...
                >
                  <div className="space-y-4 lg:max-w-2xl">
                    ...
                    <h2 className="text-2xl sm:text-4xl font-extrabold text-slate-900 dark:text-white tracking-tight group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors duration-200">
                  ...
                  <div className="flex-shrink-0 w-full lg:w-auto">
                    <span className="inline-flex items-center gap-2 rounded-xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 px-6 py-3.5 text-sm font-semibold text-slate-900 dark:text-white shadow-sm group-hover:bg-indigo-600 group-hover:text-white group-hover:border-indigo-600 transition-all duration-250 w-full lg:w-auto justify-center">
                      Comenzar lectura →
                    </span>
                  </div>
                </div>
          ...
          {/* CUADRÍCULA DE LECTURAS RESTANTES (Grid Secundario más ligero) */}
          <Section>
            <div className="max-w-7xl mx-auto">
              <div className="mb-8">
