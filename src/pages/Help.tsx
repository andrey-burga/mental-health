        ...
        <main className="flex-grow">
          ...
          <Section>
            <div className="relative max-w-7xl mx-auto pt-16 pb-6">
              ...
              <div className="max-w-3xl">
                ...
                <p className="mt-4 text-lg sm:text-xl text-slate-600 dark:text-slate-400 font-light leading-relaxed">
          ...
          <Section>
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-16">
              ...
              <div className="lg:w-7/12 rounded-3xl border border-slate-200/60 bg-white/60 p-6 sm:p-8 dark:border-slate-800/60 dark:bg-slate-900/20 backdrop-blur-sm">
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={index} className="flex items-start gap-4 text-sm sm:text-base font-light text-slate-700 dark:text-slate-300">
          ...
          <Section>
            <div className="max-w-7xl mx-auto">
              <div className="mb-8">
                ...
                <p className="text-slate-600 dark:text-slate-400 font-light text-sm sm:text-base mt-2">
          ...
          <Section>
            <div className="rounded-3xl border border-slate-200/60 bg-white/70 dark:border-slate-800/60 dark:bg-slate-900/40 p-8 sm:p-12 text-center max-w-4xl mx-auto shadow-xl backdrop-blur-md space-y-6">
