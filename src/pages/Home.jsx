    ...
    <>
      <PageTransition>
        ...
        <Section>
          <div className="relative">
            ...
            <p className="mt-2 text-gray-700 max-w-2xl">
              Información clara y accesible sobre salud mental, autocuidado y
              recursos de ayuda para acompañarte cuando lo necesites.
            </p>

            {/* DraggableBox flotante – solo desktop */}
            <div className="hidden lg:block absolute top-[60px] left-[970px]">
              <DraggableBox boxSize={130} shape="cross" boxColor="#273835" />
            </div>
          </div>
        </Section>
        ...
        <Section title={mentalHealthIntro.title}>
          <p className="max-w-3xl">{mentalHealthIntro.paragraphs[0]}</p>
        </Section>
        ...
        <Section title="Autocuidado y bienestar">
          <p className="mb-8 text-gray-700 max-w-2xl">
            Pequeñas acciones cotidianas pueden tener un impacto positivo en la
            salud mental.
          </p>
        ...
        <Section title="Artículos y reflexiones">
          <p className="mb-8 text-gray-700 max-w-2xl">
            Lecturas pensadas para comprender mejor la salud mental y fortalecer
        ...
        <Section>
          <div className="rounded-2xl border border-default bg-neutral-primary-soft p-8 text-center">
            ...
            <p className="mb-6 text-gray-700 max-w-xl mx-auto">
              Buscar ayuda es una decisión valiente. Existen recursos y personas
