...
function Home() {
  return (
    <PageTransition>
      ...
      {/* HERO SECTION – Rediseñado con orbes de fondo y mayor impacto editorial */}
      <Section>
        <div className="relative max-w-7xl mx-auto pt-16 pb-12 flex flex-col lg:flex-row items-center justify-between gap-12">
          
          {/* Orbes de luz decorativos de fondo (Glow Effects) */}
          ...
          <div className="max-w-2xl space-y-6 text-center lg:text-left">
            ...
            <div className="flex flex-wrap gap-4 justify-center lg:justify-start pt-2">
              ...
              <Link
                to="/salud-mental"
                className="rounded-xl border border-slate-200 bg-white px-6 py-3 text-sm font-medium text-slate-700 shadow-sm hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-300 dark:hover:bg-slate-800/50 transition-all duration-200"
              >
                Explorar conceptos
              </Link>
            </div>
          ...
          {/* Tarjeta Visual fija y asimétrica en lugar de la cruz flotante */}
          <div className="w-full max-w-md lg:w-[440px] flex-shrink-0 relative">
            ...
            <div className="relative rounded-3xl border border-slate-200/80 bg-white/80 p-6 backdrop-blur-md dark:border-slate-800/80 dark:bg-slate-950/80 shadow-xl">
              <div className="flex items-center gap-3 mb-4">
                <div className="h-3 w-3 rounded-full bg-emerald-500 animate-pulse" />
                <span className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Reflexión diaria</span>
              </div>
              <p className="text-slate-700 dark:text-slate-300 font-serif italic text-base sm:text-lg leading-relaxed">
      ...
      {/* STATS – Presentado ahora como sección de contexto de alto impacto */}
      <Section>
        <div className="max-w-7xl mx-auto bg-slate-50/50 dark:bg-slate-900/30 border border-slate-100 dark:border-slate-800/60 rounded-3xl p-8 sm:p-10">
      ...
      {/* AUTOCUIDADO – Layout asimétrico de dos columnas */}
      <Section>
      ...
      {/* ARTÍCULOS – Estilo Grid refinado */}
      <Section>
