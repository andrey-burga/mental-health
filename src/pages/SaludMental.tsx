...
function SaludMental() {
  ...
  return (
    <PageTransition>
      ...
      {/* ¿QUÉ ES? E IMPORTANCIA - Fusionados en un layout asimétrico de dos columnas */}
      <Section>
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-16">
          ...
          <div className="lg:w-1/2 space-y-4">
            ...
            <div className="space-y-4 text-slate-600 dark:text-slate-400 leading-relaxed font-light text-base sm:text-lg">
          ...
          <div className="lg:w-1/2 rounded-3xl border border-slate-100 bg-slate-50/40 p-6 sm:p-8 dark:border-slate-800/60 dark:bg-slate-900/20">
      ...
      {/* MITOS Y VERDADES - Tarjetas más fluidas con layouts internos limpios */}
      <Section>
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid gap-6 max-w-5xl">
            {[
              ...
              <div key={idx} className="grid sm:grid-cols-2 gap-0 border border-slate-200/60 dark:border-slate-800 rounded-2xl overflow-hidden shadow-sm transition-all duration-300 hover:shadow-md">
                <div className="bg-red-50/30 dark:bg-red-950/10 p-6 border-b sm:border-b-0 sm:border-r border-slate-200/60 dark:border-slate-800 flex flex-col justify-center">
                  ...
                  <p className="text-sm sm:text-base text-slate-800 dark:text-slate-200 font-medium leading-relaxed">{item.m}</p>
                </div>
                <div className="bg-emerald-50/20 dark:bg-emerald-950/5 p-6 flex flex-col justify-center">
                  ...
                  <p className="text-sm sm:text-base text-slate-800 dark:text-slate-200 font-medium leading-relaxed">{item.v}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <Section>
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            ...
            <p className="max-w-3xl text-slate-600 dark:text-slate-400 font-light text-sm sm:text-base">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {loadingDisorders ? (
              Array.from({ length: 4 }).map((_, idx) => (
                <div key={idx} className="w-full h-36 rounded-2xl bg-slate-100 dark:bg-slate-800 animate-pulse" />
              ))
            ) : (
      ...
      {/* CTA */}
      <Section>
        <div className="rounded-3xl border border-indigo-100/80 bg-gradient-to-br from-indigo-50/40 to-violet-50/40 backdrop-blur-sm p-8 sm:p-12 text-center max-w-4xl mx-auto shadow-sm dark:border-slate-800/60 dark:from-indigo-950/20 dark:to-slate-900/40">
          ...
          <p className="mb-8 text-slate-600 dark:text-slate-400 max-w-xl mx-auto text-sm sm:text-base font-light leading-relaxed">
