...
function Register() {
  ...
  return (
    <PageTransition>
      {/* 1. Forzamos a que todo el componente ocupe el alto de la pantalla sin scroll */}
      <div className="h-screen w-screen flex flex-col overflow-hidden  from-slate-50 to-gray-100 dark:from-slate-950 dark:to-slate-900">
        ...
        {/* 2. flex-1 toma el espacio restante exacto. items-center y justify-center lo centran a la perfección */}
