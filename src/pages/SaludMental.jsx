      ...
      <PageTransition>
        ...
        <Section title="¿Por qué es importante la salud mental?">
          <div className="space-y-4 text-gray-700">
            <p>
              ...
              cambio, fortalece la resiliencia y el bienestar emocional.
            </p>
          </div>
        </Section>
        ...
        <Section title="Mitos y verdades sobre la salud mental">
          <ul className="list-disc pl-6 space-y-3 max-w-3xl text-gray-700">
            <li>
              <strong>Mito:</strong> Solo las personas “débiles” tienen
            ...
            <li>
              <strong>Mito:</strong> Hablar de salud mental empeora los
              problemas.
              <br />
        ...
        <Section>
          <div className="rounded-2xl border border-default bg-neutral-primary-soft p-6 max-w-3xl">
            ...
            <p className="mb-4 text-gray-700">
              ...
              Existen recursos, profesionales y personas dispuestas a
              acompañarte.
            </p>
