      ...
      <PageTransition>
        ...
        <Section title="Factores de riesgo para la salud mental">
          <p className="max-w-3xl text-gray-700">
            ...
            saludables para el bienestar emocional.
          </p>
        </Section>
        ...
        <Section>
          <div className="rounded-2xl border border-default bg-neutral-primary-soft p-6 ">
            ...
            <p className="text-gray-700">
              ...
              significativamente tu bienestar emocional, buscar apoyo
              profesional o conversar con alguien de confianza puede marcar la
              diferencia.
            </p>
          </div>
        </Section>
